  ...
  try {
    ...
    if (sortBy === 'quality') {
      ...
      const results = calls.map(call => ({
        ...
        group_name: call.source === 'gecko_trending' ? 'GT Trending' : (call.raw_data?.groupName || call.raw_data?.group?.name || 'Unknown'),
        ...
        x_analysis_summary: call.x_analysis_summary,
        x_analysis_best_tweet: call.x_analysis_best_tweet,
